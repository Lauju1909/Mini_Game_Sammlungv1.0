...
TRANSLATIONS["de"] = {
    ...
    "game_audio_math_desc": "Löse Mathe-Aufgaben unter Zeitdruck!",
    "game_audio_math_instructions": "Höre dir die Mathe-Aufgabe an, tippe die Antwort ein und drücke Enter! Beeil dich!",
    ...
    "game_audio_fencer_instructions": "Du hörst, wie der Gegner sich nähert (Rascheln). Kurz danach schlägt er zu (Zisch-Geräusch). Drücke in diesem Moment Pfeil Runter, um zu blocken (Metall-Klick). Drücke danach sofort Pfeil Hoch, um anzugreifen! Fehler kosten Leben.",
    "fencer_fight_start": "En garde!",
    "fencer_enemy_hit": "Treffer! Gegner hat noch {hp} Leben.",
    "fencer_enemy_defeated": "Gegner besiegt! Nächste Runde.",
    "fencer_player_hit": "Du wurdest getroffen! Noch {lives} Leben.",
    "fencer_gameover": "Du wurdest besiegt!",
    "game_audio_lumberjack": "Audio Holzfäller",
    "game_audio_lumberjack_desc": "Fälle den Baum mit der Leertaste und weiche aus, wenn er fällt!",
    "game_audio_lumberjack_instructions": "Drücke die Leertaste mehrmals, um den Baum zu fällen. Wenn du ein Knarren hörst, fällt der Baum! Achte darauf, ob das Geräusch von links oder rechts kommt, und drücke schnell die Pfeiltaste in die ENTGEGENGESETZTE Richtung, um auszuweichen. Hast du 0 Leben, ist das Spiel vorbei.",
    "lumberjack_tree_ready": "Baum bereit!",
    "lumberjack_crushed": "Der Baum hat dich erwischt! {lives} Leben übrig.",
    ...
    "game_audio_frogger_desc": "Überquere blind eine vielbefahrene Straße.",
    ...
    "game_frogger_desc": "Überquere blind eine vielbefahrene Straße.",
    "game_frogger_instructions": "Du stehst sicher am Straßenrand. Du hörst die Autos der Spur direkt vor dir (mit Panning und Doppler-Effekt). Erkenne die Lücke im Verkehr und drücke Pfeil Oben, um im perfekten Moment über die Spur zu hüpfen! Schaffst du 10 Spuren, erreichst du das nächste Level.",
    ...
    "game_audio_train_desc": "Stelle die Weichen richtig für Schnellzüge und Güterzüge.",
    "game_audio_train_instructions": "Hörst du einen hohen Ton, ist es ein Schnellzug: Drücke Pfeil Oben. Hörst du einen tiefen Ton, ist es ein Güterzug: Drücke Pfeil Unten. Stelle die Weiche, bevor der Zug ankommt!",
    "train_success": "Zug sicher durchgefahren!",
    "train_crash": "Zusammenstoß! Noch {lives} Leben.",
}
